...
class addFilm extends Component {
  ...
  handleSubmit = () => {
    const { uploadArtistData, uploadEpisodes } = this.state;
    this.props.addDataMovie(uploadArtistData, uploadEpisodes);
  };
...
export default compose(withStyles(styles), connect(mapStateToProps, { getDataTypesAction }))(addFilm);
